...
```{r out.width="100%", echo=FALSE}
ran1 <- plotRanks(res1$data, measures[mindex], "perf", decreasing=FALSE)
ran1$p
ran2 <- plotRanks(res2$data, measures[mindex], "norm", decreasing=FALSE)
ran2$p
ran3 <- plotRanks(res3$data, measures[mindex], "quan", decreasing=FALSE)
ran3$p
ran4 <- plotRanks(res4$data, measures[mindex], "irank", decreasing=FALSE)
ran4$p
ran5 <- plotRanks(res5$data, measures[mindex], "rank", decreasing=FALSE)
ran5$p
ran6 <- plotRanks(res6$data, measures[mindex], "qrank", decreasing=FALSE)
ran6$p
